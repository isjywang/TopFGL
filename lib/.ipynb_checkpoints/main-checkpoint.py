...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode',type=str, default='heterogeneity')
    ...
    parser.add_argument('--alg', type=str, default='topfgl')
    ...
    if args.alg == 'topfgl':
        run_topfgl(args, init_clients, init_server, args.num_rounds, args.local_epoch)
    elif args.alg == 'local':
