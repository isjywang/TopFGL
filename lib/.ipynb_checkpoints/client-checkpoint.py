...
class Client_topfgl():
    ...
    def local_train(self, local_epoch):
        train_stats = train_topfgl(self.model, self.topology_learner, self.dataLoader, self.optimizer, self.structual_optimizer, local_epoch, self.args.device, self.id)
