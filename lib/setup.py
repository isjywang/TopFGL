...
def init_FGL_parti(splitedData, args):
    ...
    for c in range(args.clients):
        ...
        if args.alg == 'fedtop':
            ...
            set_seed(args)
            clients.append(   Client_fedtop(main_model, c, train_size, client_graph, optimizer, args, topology_learner, optimizer_struct, num_labels)) 
        else: 
    ...
    if args.alg == 'fedtop':
        ...
        for i in range(args.clients):
            ...
            set_seed(args)
        server = Server_fedtop(main_model, topology_learner, args.device, num_features, num_labels, args, all_model, all_model_t)
